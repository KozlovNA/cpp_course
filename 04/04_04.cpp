...
////////////////////////////////////////////////////////////////////////////////
  ...
  Vector<double> vector_1_double;

  Vector<double> vector_2_double = {1.5, 2.5, 3.5, 4.5, 5};

  vector_2_double.push_back(6.9);

  for (auto i = 0uz; i < vector_2_double.get_size(); i++) {
    std::cout << vector_2_double.get_array()[i] << ' ';
  }
  std::cout << '\n'
            << vector_2_double.get_capacity() << '\n'
            << vector_2_double.get_size() << '\n';

  assert(!vector_2_double.empty());
  vector_2_double.clear();
  assert(vector_2_double.get_capacity() == 10 && vector_2_double.get_size() == 0);
  assert(vector_2_double.empty());

  Vector vector_3_double = vector_2_double;

  Vector vector_4_double = std::move(vector_3_double);

  //  --------------------------------------

  vector_3_double = vector_2_double;

  vector_4_double = std::move(vector_3_double);
}
