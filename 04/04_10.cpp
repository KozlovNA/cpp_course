...
template < typename T, typename D, bool C = is_empty_v < D > > struct Has {};

////////////////////////////////////////////////////////////////////////////////////////////////

template < typename T, typename D > struct Has < T, D, false >
{
    constexpr static bool value = std::is_same_v < T, front < D > > || Has < T, pop_front < D > > ::value;
};
...
template < typename T, typename D > constexpr bool has_v = Has < T, D > ::value;
...
//  ------------------------------------------------------------------------------------------
    ...
    static_assert(has_v < int, Deque < int, double, float > > == true);

    static_assert(has_v < double, Deque < int, double, float > > == true);

    static_assert(has_v < float, Deque < int, double, float > > == true);

    static_assert(has_v < char, Deque < int, double, float > > == false);
